                ...
                if isCompact {
                    ...
                    .overlay(alignment: .center) {
                        ...
                        .position(
                            ...
                            y: showVotes ? max(geometry.size.height * 0.3, geometry.size.height * redPercent) : geometry.size.height / 2
                        )
                        .animation(.easeInOut(duration: 1.0), value: redPercent)
                    }
                } else {
                    ...
                    .overlay(alignment: .center) {
                        ...
                        .position(
                            x: showVotes ? geometry.size.width * redPercent : geometry.size.width / 2,
