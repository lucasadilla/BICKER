...
export default function Leaderboard() {
    ...
    const fetchStats = async () => {
        try {
            ...
            const totalVotes = deliberations.reduce((sum, d) => sum + (d.votesRed || 0) + (d.votesBlue || 0), 0);
            const redVotes = deliberations.reduce((sum, d) => sum + (d.votesRed || 0), 0);
            const blueVotes = deliberations.reduce((sum, d) => sum + (d.votesBlue || 0), 0);
            ...
            <div style={{ 
                ...
                <div style={{ 
                    ...
                    <div style={{ 
                        ...
                        <p style={{ fontSize: '24px', fontWeight: 'bold', color: '#4D94FF' }}>
                            {stats.totalVotes}
                        </p>
                    </div>
